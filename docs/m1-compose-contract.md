...
Ship one versioned application image reference with a multi-platform manifest containing `linux/amd64` and `linux/arm64`. The release Compose file resolves that single reference; do not create separate Mac and Linux product images or force amd64 emulation on Apple Silicon. A release manifest pins the app manifest digest and a tested multi-platform Ollama image digest. The v0.1.0 Ollama candidate is `docker.io/ollama/ollama@sha256:684d8674b4315fa18f4f0e973a118ec2652ed96f67563277839985175858e0ba`; registry inspection on 2026-09-10 found Linux amd64 child `sha256:aa6f86f01fee264c81f1edd9083ebfb07c8116d95d8bedd1ad470874b66a40b4` and Linux arm64 child `sha256:8a39a0a3ef5a08cd7206fe2d2ffbbc3d7aee9d7b22e0e2098d17c4bdf1b0b7e9`. Inspection is not qualification: it remains unaccepted until live QA passes on both targets. The Project Paper release image reference and exact runtime versions must still be assigned before publishing; never advertise a placeholder as pullable.
