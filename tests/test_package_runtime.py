...
class WorkflowContractTests(unittest.TestCase):
    ...
    def test_release_acceptance_is_manual_exact_image_linux_gate(self):
        ...
        for behavior in ("install_project_paper.sh", "PAPER_ACCEPTANCE_PORT", "scout-last.log", "/topics", "/scout/run", "/feedback", "force-recreate app", "scout_recovery=interrupted", "down --volumes"):
