...
class BackendV2Tests(unittest.TestCase):
    ...
    def test_review_queue_renders_simplified_review_workflow(self):
        ...
        self.assertIn('name="view" value="full" class="view-option current" aria-label="Full view"', html)
        self.assertIn('name="view" value="compact" class="view-option" aria-label="Condensed view"', html)
